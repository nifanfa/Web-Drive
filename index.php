...
<html>
    ...
    <body>
        ...
        echo "<div style=\"width: 200px;height: 10px;background:rgb(227, 227, 227);border-radius: 5px;overflow: hidden;\"><div style=\"width: $availablepercent%;height: 10px;background: green\"></div></div>"
        ?></label>
        <br>
